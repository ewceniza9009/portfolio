...
export default function ExperienceTab() {
  ...
  const handleEdit = (item: any) => {
    ...
    setFormData({
      ...item,
      descriptions: item.descriptions?.length ? item.descriptions : [''],
  ...
  const handleCreate = () => {
    ...
    setFormData({
      ...
      descriptions: [''], techStr: '', display_order: items.length
    })
  }
  ...
  const handleSave = async () => {
    try {
      const payload = {
        ...formData,
        descriptions: formData.descriptions.filter((s: string) => s.trim()),
