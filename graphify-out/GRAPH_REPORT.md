...
## Summary
- 355 nodes · 477 edges · 28 communities (22 shown, 6 thin omitted)
...
Cohesion: 0.07
Nodes (27): AdminPanel(), AdminPanelProps, AI_PRESETS, Blog, Comment, formatDate(), getSafeItem(), Message (+19 more)
...
Cohesion: 0.10
Nodes (20): PortfolioProps, BlogPostPageProps, BlogsPageProps, GitHubSectionProps, HeroSectionProps, ROLES, ACCENT_DROPDOWN_STYLE, BLOG_BTN_DESKTOP_STYLE() (+12 more)
...
Cohesion: 0.09
Nodes (11): ContactSectionProps, CopyableContactProps, SocialLinkProps, ADVENTURE_STORY, AdventureChoice, AdventureNode, ChatMessage, HistoryLine (+3 more)

### Community 7 - "dependencies"
Cohesion: 0.09
Nodes (22): dependencies, chart.js, clsx, cors, express, framer-motion, @google/generative-ai, jsonwebtoken (+14 more)
...
### Community 15 - "InteractiveBlock.tsx"
Cohesion: 0.40
...
## Knowledge Gaps
- **153 isolated node(s):** `AuthRequest`, `loginAttempts`, `app`, `INDEXNOW_ENDPOINTS`, `visitRateLimit` (+148 more)
